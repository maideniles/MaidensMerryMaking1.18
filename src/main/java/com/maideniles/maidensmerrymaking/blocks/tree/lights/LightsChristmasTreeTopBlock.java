...
public class LightsChristmasTreeTopBlock extends BushBlock {

    protected static final VoxelShape SHAPE = Block.box(2.0D, 0.0D, 2.0D, 14.0D, 16.0D, 14.0D);

    public LightsChristmasTreeTopBlock(Properties properties) {
        super(properties);
    ...
    public void playerWillDestroy(Level level, BlockPos pos, BlockState state, Player player) {
        ...
        if ( blockstate2.getBlock() == ModBlocks.CHRISTMAS_TREE_WHITE_LIGHTS_MIDDLE.get()) {
